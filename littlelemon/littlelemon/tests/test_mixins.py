...
BOOKINGS={
    1: {'name' : 'Vill'},
    2: {'name' : 'Jani', 'no_of_guests':randint(1, 8)},
    3: {'name': 'Niilo', 'no_of_guests': randint(1, 11)},
    4: {'name': 'Markus', 'no_of_guests': randint(1, 11)},
}
...
class SingleBookingMixin:
    ...
    def create_booking(self):
        ...
        if self.booking.get('booking_date') is not None:
            booking.booking_date = self.booking.get('booking_date')
        booking.save()
